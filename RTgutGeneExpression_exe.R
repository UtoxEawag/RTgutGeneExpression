...
#############################################
# PLEASE MODIFY ACCORDING TO EXPERIMENT
# set the fixed values in the experimental system
...
InName_data <- "DataInput.txt"
InName_info <- "SampleInfo.txt"
title_name <- "ExampleDataRTgutGeneExpression"
OutName <- "ExampleDataRTgutGeneExpression.xlsx" #define a name on how to save the excel file
